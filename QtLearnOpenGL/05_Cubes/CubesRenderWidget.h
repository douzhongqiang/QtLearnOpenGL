#ifndef CUBERSENDERWIDGET_H
#define CUBERSENDERWIDGET_H
...
class CubesRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_2_0
{
    Q_OBJECT

public:
    CubesRenderWidget(QWidget* parent = nullptr);
    ~CubesRenderWidget();
