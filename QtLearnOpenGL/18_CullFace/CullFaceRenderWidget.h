#ifndef CULLFACERENDERWIDGET_H
#define CULLFACERENDERWIDGET_H
...
class COpenGLModel;
class COpenGLMesh;
class CullFaceRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_3_3_Core
{
    Q_OBJECT
...
public:
    CullFaceRenderWidget(QWidget* parent = nullptr);
    ~CullFaceRenderWidget();
