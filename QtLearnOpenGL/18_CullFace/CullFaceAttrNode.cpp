...
CullFaceAttrNode::CullFaceAttrNode(QObject* parent)
    :NDNodeBase(parent)
{
    initAttribute();
}

CullFaceAttrNode::~CullFaceAttrNode()
{

}

void CullFaceAttrNode::initAttribute(void)
{
    // 添加光的材质信息
    ...
    QObject::connect(m_pLightPostionAttr, &NDRealAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightAmbientColorAttr, &NDRealAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightDiffuseColorAttr, &NDRealAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightSpecularColorAttr, &NDRealAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraPosAttr, &NDRealAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraFront, &NDRealAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);

    // 添加面剔除属性组
    this->addAttributeGroup(this->getCullFaceAttrGroup());
}

NDAttributeGroup* CullFaceAttrNode::getCullFaceAttrGroup(void)
{
    // 面剔除
    ...
    QObject::connect(m_pCullFaceEnabledAttr, &NDBoolAttribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCullFaceTypeAttr, &NDString2Attribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pFrontFaceTypeAttr, &NDString2Attribute::valueChanged, this, &CullFaceAttrNode::attributeValueChanged);

    return pCullFaceAttrGroup;
}

void CullFaceAttrNode::setLightInfo(const CullFaceRenderWidget::LightInfo& lightInfo)
{
...
CullFaceRenderWidget::LightInfo CullFaceAttrNode::getLightInfo(void)
{
    CullFaceRenderWidget::LightInfo lightInfo;
...
void CullFaceAttrNode::setCameraPostion(const QVector3D& cameraPos)
{
    m_pCameraPosAttr->setValue(cameraPos);
}

QVector3D CullFaceAttrNode::getCameraPostion()
{
    return m_pCameraPosAttr->getValue().value<QVector3D>();
}

void CullFaceAttrNode::setCameraFront(const QVector3D& cameraFront)
{
    m_pCameraFront->setValue(cameraFront);
}

QVector3D CullFaceAttrNode::getCameraFront(void)
{
    return m_pCameraFront->getValue().value<QVector3D>();
}

// 面剔除相关
void CullFaceAttrNode::setCullFaceEnabled(bool isEnabled)
{
    m_pCullFaceEnabledAttr->setValue(isEnabled);
}

bool CullFaceAttrNode::isCullFaceEnabled(void)
{
    return m_pCullFaceEnabledAttr->getValue().toBool();
}

// 设置要剔除的面
void CullFaceAttrNode::setCullFaceType(CullFaceRenderWidget::CullFaceType type)
{
    m_pCullFaceTypeAttr->setCurrentSelectedIndex((int)type);
}

CullFaceRenderWidget::CullFaceType CullFaceAttrNode::getCullFaceType(void)
{
    return (CullFaceRenderWidget::CullFaceType)m_pCullFaceTypeAttr->getCurrentSelectedIndex();
}

// 设置正面的顺序
void CullFaceAttrNode::setFrontOrderType(CullFaceRenderWidget::FrontFaceOrderType type)
{
    m_pFrontFaceTypeAttr->setCurrentSelectedIndex((int)type);
}

CullFaceRenderWidget::FrontFaceOrderType CullFaceAttrNode::getFrontOrderType(void)
{
    return (CullFaceRenderWidget::FrontFaceOrderType)m_pFrontFaceTypeAttr->getCurrentSelectedIndex();
}
