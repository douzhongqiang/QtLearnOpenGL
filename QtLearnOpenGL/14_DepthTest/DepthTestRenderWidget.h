#ifndef DEPTHTESTRENDERWIDGET_H
#define DEPTHTESTRENDERWIDGET_H
...
class COpenGLModel;
class COpenGLMesh;
class DepthTestRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_3_3_Core
{
    Q_OBJECT
...
public:
    DepthTestRenderWidget(QWidget* parent = nullptr);
    ~DepthTestRenderWidget();
