...
DepthTestAttrNode::DepthTestAttrNode(QObject* parent)
    :NDNodeBase(parent)
{
    initAttribute();
}

DepthTestAttrNode::~DepthTestAttrNode()
{

}

void DepthTestAttrNode::initAttribute(void)
{
    // 添加光的材质信息
    ...
    QObject::connect(m_pLightPostionAttr, &NDRealAttribute::valueChanged, this, &DepthTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightAmbientColorAttr, &NDRealAttribute::valueChanged, this, &DepthTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightDiffuseColorAttr, &NDRealAttribute::valueChanged, this, &DepthTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightSpecularColorAttr, &NDRealAttribute::valueChanged, this, &DepthTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraPosAttr, &NDRealAttribute::valueChanged, this, &DepthTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraFront, &NDRealAttribute::valueChanged, this, &DepthTestAttrNode::attributeValueChanged);
}

void DepthTestAttrNode::setLightInfo(const DepthTestRenderWidget::LightInfo& lightInfo)
{
...
DepthTestRenderWidget::LightInfo DepthTestAttrNode::getLightInfo(void)
{
    DepthTestRenderWidget::LightInfo lightInfo;
...
void DepthTestAttrNode::setCameraPostion(const QVector3D& cameraPos)
{
    m_pCameraPosAttr->setValue(cameraPos);
}

QVector3D DepthTestAttrNode::getCameraPostion()
{
    return m_pCameraPosAttr->getValue().value<QVector3D>();
}

void DepthTestAttrNode::setCameraFront(const QVector3D& cameraFront)
{
    m_pCameraFront->setValue(cameraFront);
}

QVector3D DepthTestAttrNode::getCameraFront(void)
{
