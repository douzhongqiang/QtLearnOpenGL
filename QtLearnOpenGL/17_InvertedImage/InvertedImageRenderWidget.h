#ifndef INVERTEDIMAGERENDERWIDGET_H
#define INVERTEDIMAGERENDERWIDGET_H
...
class COpenGLModel;
class COpenGLMesh;
class InvertedImageRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_3_3_Core
{
    Q_OBJECT
...
public:
    InvertedImageRenderWidget(QWidget* parent = nullptr);
    ~InvertedImageRenderWidget();
