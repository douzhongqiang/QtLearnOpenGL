...
StencilTestAttrNode::StencilTestAttrNode(QObject* parent)
    :NDNodeBase(parent)
{
    initAttribute();
}

StencilTestAttrNode::~StencilTestAttrNode()
{

}

void StencilTestAttrNode::initAttribute(void)
{
    // 添加光的材质信息
    ...
    QObject::connect(m_pLightPostionAttr, &NDRealAttribute::valueChanged, this, &StencilTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightAmbientColorAttr, &NDRealAttribute::valueChanged, this, &StencilTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightDiffuseColorAttr, &NDRealAttribute::valueChanged, this, &StencilTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightSpecularColorAttr, &NDRealAttribute::valueChanged, this, &StencilTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraPosAttr, &NDRealAttribute::valueChanged, this, &StencilTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraFront, &NDRealAttribute::valueChanged, this, &StencilTestAttrNode::attributeValueChanged);
}

void StencilTestAttrNode::setLightInfo(const StencilTestRenderWidget::LightInfo& lightInfo)
{
...
StencilTestRenderWidget::LightInfo StencilTestAttrNode::getLightInfo(void)
{
    StencilTestRenderWidget::LightInfo lightInfo;
...
void StencilTestAttrNode::setCameraPostion(const QVector3D& cameraPos)
{
    m_pCameraPosAttr->setValue(cameraPos);
}

QVector3D StencilTestAttrNode::getCameraPostion()
{
    return m_pCameraPosAttr->getValue().value<QVector3D>();
}

void StencilTestAttrNode::setCameraFront(const QVector3D& cameraFront)
{
    m_pCameraFront->setValue(cameraFront);
}

QVector3D StencilTestAttrNode::getCameraFront(void)
{
