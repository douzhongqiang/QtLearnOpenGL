#ifndef STENCILTESTRENDERWIDGET_H
#define STENCILTESTRENDERWIDGET_H
...
class COpenGLModel;
class COpenGLMesh;
class StencilTestRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_3_3_Core
{
    Q_OBJECT
...
public:
    StencilTestRenderWidget(QWidget* parent = nullptr);
    ~StencilTestRenderWidget();
