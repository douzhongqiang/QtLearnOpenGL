...
CubemapsWidget::CubemapsWidget(QWidget* parent)
    :QWidget(parent)
{
    ...
    // 添加节点属性
    m_pDepthTestAttrNode = new CubemapsAttrNode(this);
    ...
    QObject::connect(m_pDepthTestAttrNode, &CubemapsAttrNode::attributeValueChanged, this, &CubemapsWidget::onAttributeChanged);
}

CubemapsWidget::~CubemapsWidget()
{

}

QWidget* CubemapsWidget::createRenderWidget(void)
{
    ...
    // 添加渲染界面
    m_pRenderWidget = new CubemapsRenderWidget;
    QObject::connect(m_pRenderWidget, &CubemapsRenderWidget::attributeInfoChanged, this, &CubemapsWidget::onAttributeInfoChanged);
...
void CubemapsWidget::onAttributeChanged(const QVariant& variant, bool isCmd)
{
...
void CubemapsWidget::onAttributeInfoChanged(void)
{
    m_pDepthTestAttrNode->setLightInfo(m_pRenderWidget->getLightInfo());
