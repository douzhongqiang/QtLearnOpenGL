...
GeometryShaderRenderWidget2::GeometryShaderRenderWidget2(QWidget* parent)
...
GeometryShaderRenderWidget2::~GeometryShaderRenderWidget2()
{
    qDebug() << __FUNCTION__;
}

void GeometryShaderRenderWidget2::initializeGL()
{
...
void GeometryShaderRenderWidget2::resizeGL(int w, int h)
{
...
void GeometryShaderRenderWidget2::paintGL()
{
...
bool GeometryShaderRenderWidget2::initShaderProgram(void)
{
    // 加载顶点着色器
    ...
    // 添加几何着色器
    QString geometryShaderStr(":/21_GeometryShader/shader/gometryshader2.gsh");
...
void GeometryShaderRenderWidget2::initPoints(void)
{
