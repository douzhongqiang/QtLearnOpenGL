#ifndef LIGHTMAPRENDERWIDGET_H
#define LIGHTMAPRENDERWIDGET_H
...
class COpenGLCamera;
class LightMapRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_2_0
{
    Q_OBJECT
...
public:
    LightMapRenderWidget(QWidget* parent = nullptr);
    ~LightMapRenderWidget();
