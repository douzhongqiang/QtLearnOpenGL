...
BlendTestAttrNode::BlendTestAttrNode(QObject* parent)
    :NDNodeBase(parent)
{
    initAttribute();
}

BlendTestAttrNode::~BlendTestAttrNode()
{

}

void BlendTestAttrNode::initAttribute(void)
{
    // 添加光的材质信息
    ...
    QObject::connect(m_pLightPostionAttr, &NDRealAttribute::valueChanged, this, &BlendTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightAmbientColorAttr, &NDRealAttribute::valueChanged, this, &BlendTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightDiffuseColorAttr, &NDRealAttribute::valueChanged, this, &BlendTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightSpecularColorAttr, &NDRealAttribute::valueChanged, this, &BlendTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraPosAttr, &NDRealAttribute::valueChanged, this, &BlendTestAttrNode::attributeValueChanged);
    ...
    QObject::connect(m_pCameraFront, &NDRealAttribute::valueChanged, this, &BlendTestAttrNode::attributeValueChanged);
}

void BlendTestAttrNode::setLightInfo(const BlendTestRenderWidget::LightInfo& lightInfo)
{
...
BlendTestRenderWidget::LightInfo BlendTestAttrNode::getLightInfo(void)
{
    BlendTestRenderWidget::LightInfo lightInfo;
...
void BlendTestAttrNode::setCameraPostion(const QVector3D& cameraPos)
{
    m_pCameraPosAttr->setValue(cameraPos);
}

QVector3D BlendTestAttrNode::getCameraPostion()
{
    return m_pCameraPosAttr->getValue().value<QVector3D>();
}

void BlendTestAttrNode::setCameraFront(const QVector3D& cameraFront)
{
    m_pCameraFront->setValue(cameraFront);
}

QVector3D BlendTestAttrNode::getCameraFront(void)
{
