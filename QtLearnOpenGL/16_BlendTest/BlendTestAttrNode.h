#ifndef BLENDTESTATTRNODE_H
#define BLENDTESTATTRNODE_H
...
class BlendTestAttrNode : public NDNodeBase
{
    Q_OBJECT

public:
    BlendTestAttrNode(QObject* parent = nullptr);
    ~BlendTestAttrNode();

    // 设置和获取光的信息
    void setLightInfo(const BlendTestRenderWidget::LightInfo& lightInfo);
    BlendTestRenderWidget::LightInfo getLightInfo(void);
