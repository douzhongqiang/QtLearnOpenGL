#ifndef SPOTLIGHTRENDERWIDGET_H
#define SPOTLIGHTRENDERWIDGET_H
...
class COpenGLCamera;
class SpotLightRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_2_0
{
    Q_OBJECT
...
public:
    SpotLightRenderWidget(QWidget* parent = nullptr);
    ~SpotLightRenderWidget();
