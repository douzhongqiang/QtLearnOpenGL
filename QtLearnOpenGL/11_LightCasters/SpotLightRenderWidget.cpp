...
SpotLightRenderWidget::SpotLightRenderWidget(QWidget* parent)
...
SpotLightRenderWidget::~SpotLightRenderWidget()
{
    qDebug() << __FUNCTION__;
}

void SpotLightRenderWidget::initializeGL()
{
...
void SpotLightRenderWidget::resizeGL(int w, int h)
{
...
void SpotLightRenderWidget::paintGL()
{
    ...
    m_pShaderProgram->setUniformValue("lightMaterial.direction", m_light.direction);
...
void SpotLightRenderWidget::keyPressEvent(QKeyEvent* event)
{
    if (m_pCamera)
...
void SpotLightRenderWidget::mousePressEvent(QMouseEvent* event)
{
    if (m_pCamera)
...
void SpotLightRenderWidget::mouseMoveEvent(QMouseEvent* event)
{
    if (m_pCamera)
...
void SpotLightRenderWidget::mouseReleaseEvent(QMouseEvent* event)
{
    if (m_pCamera)
...
void SpotLightRenderWidget::wheelEvent(QWheelEvent *event)
{
    if (m_pCamera)
...
bool SpotLightRenderWidget::initShaderProgram(void)
{
...
void SpotLightRenderWidget::setFillStatus(bool isFill)
{
    m_isFill = isFill;
    this->update();
}

bool SpotLightRenderWidget::isFill(void)
{
    return m_isFill;
}

// 设置/获取物体的材质
void SpotLightRenderWidget::setObjectMaterial(const ObjectMaterial& material)
{
    m_objectMaterial = material;
    this->update();
}

SpotLightRenderWidget::ObjectMaterial SpotLightRenderWidget::getObjectMaterial(void)
{
    return m_objectMaterial;
}

// 设置/获取光的属性信息
void SpotLightRenderWidget::setLightInfo(const LightInfo& info)
{
    m_light = info;
    this->update();
}

SpotLightRenderWidget::LightInfo SpotLightRenderWidget::getLightInfo(void)
{
    return m_light;
}

void SpotLightRenderWidget::initObjectMaterial(void)
{
...
void SpotLightRenderWidget::initLightInfo(void)
{
...
void SpotLightRenderWidget::initModelData(void)
{
