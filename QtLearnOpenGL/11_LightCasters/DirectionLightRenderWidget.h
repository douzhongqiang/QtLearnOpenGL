#ifndef DIRECTIONLIGHTRENDERWIDGET_H
#define DIRECTIONLIGHTRENDERWIDGET_H
...
//        QVector3D specularColor;        // 镜面反射颜色
    ...
    struct LightInfo
    {
        QVector3D lightdirection;       // 平行光的方向
...
public:
    DirectionLightRenderWidget(QWidget* parent = nullptr);
    ~DirectionLightRenderWidget();
