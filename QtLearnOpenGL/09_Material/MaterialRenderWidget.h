#ifndef MATERIALRENDERWIDGET_H
#define MATERIALRENDERWIDGET_H
...
class COpenGLCamera;
class MaterialRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_2_0
{
    Q_OBJECT
...
public:
    MaterialRenderWidget(QWidget* parent = nullptr);
    ~MaterialRenderWidget();
