...
MaterialNode::MaterialNode(QObject* parent)
    :NDNodeBase(parent)
{
    initAttribute();
}
...
void MaterialNode::initAttribute(void)
{
    // 添加物体的材质
    ...
    QObject::connect(m_pAmbientColorAttr, &NDColorAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pDiffuseColorAttr, &NDColorAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pSpecularColorAttr, &NDColorAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pShininessAtr, &NDRealAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightPostionAttr, &NDRealAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightAmbientColorAttr, &NDRealAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightDiffuseColorAttr, &NDRealAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);
    ...
    QObject::connect(m_pLightSpecularColorAttr, &NDRealAttribute::valueChanged, this, &MaterialNode::attributeValueChanged);

}

void MaterialNode::setObjectMaterial(const MaterialRenderWidget::ObjectMaterial& objectMaterial)
{
    // ambient
...
void MaterialNode::setLightInfo(const MaterialRenderWidget::LightInfo& lightInfo)
{
...
MaterialRenderWidget::ObjectMaterial MaterialNode::getObjectMaterial(void)
{
    MaterialRenderWidget::ObjectMaterial objectMaterial;
...
MaterialRenderWidget::LightInfo MaterialNode::getLightInfo(void)
{
    MaterialRenderWidget::LightInfo lightInfo;
