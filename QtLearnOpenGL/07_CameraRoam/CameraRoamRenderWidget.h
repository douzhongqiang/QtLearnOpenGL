#ifndef CAMERAROAMRENDERWIDGET_H
#define CAMERAROAMRENDERWIDGET_H
...
class CameraRoamRenderWidget : public QOpenGLWidget, public QOpenGLFunctions_2_0
{
    Q_OBJECT

public:
    CameraRoamRenderWidget(QWidget* parent = nullptr);
    ~CameraRoamRenderWidget();
